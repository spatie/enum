...
[![GitHub Tests Action Status](https://github.com/spatie/enum/actions/workflows/run-tests.yml/badge.svg)](https://github.com/spatie/enum/actions?query=workflow%3Arun-tests+branch%3Amain)
[![GitHub Code Style Action Status](https://github.com/spatie/enum/actions/workflows/php-cs-fixer.yml/badge.svg)](https://github.com/spatie/enum/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
